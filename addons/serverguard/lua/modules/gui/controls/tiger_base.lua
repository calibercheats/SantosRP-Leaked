...
function panel:AddSection(name, material, callback, flag)
	...
	function base:Paint(w, h)
		...
		if (self.selected) then
			...
			draw.SimpleText(name, "tiger.base.section", w /2, h -24, theme.tiger_base_section_label_selected, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
			...
			draw.SimpleText(name, "tiger.base.section", w /2, h -24, theme.tiger_base_section_label, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
