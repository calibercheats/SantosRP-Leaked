...
--
--Gamemode HAX
hook.Add( "GamemodeOnInventoryUpdated", "UpdateFAS2AttachHack", function( tblItems )
	FAS2AttOnMe = {}
	for itemID, _ in pairs( tblItems ) do
		if GAMEMODE.Inv:GetItem( itemID ).WeaponAttachENT then
			table.insert( FAS2AttOnMe, GAMEMODE.Inv:GetItem(itemID).WeaponAttachENT )
		end
	end
end )