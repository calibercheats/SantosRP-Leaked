...
function SWEP:Initialize()
	...
	self.freq = 120 --Default freqeunz (devide 10 || default = 900)
	self.locked_freq = false --Should the frequency be locked? if true you don't have to put values into freq min and max
	self.freq_min = 100 --Min frequenz (default = 800)
	self.freq_max = 120 --Max frequenz (default = 900)
