...
function ENT:ConfigInit()
	if SERVER then
		self:SetModel( "models/foodnhouseholditems/juice.mdl" )
		...
		self:SetFluidID( "Orange Juice" )
		self:SetEffect( "waterFx", Vector(-0.088151, -0.650788, 8.061775), Color(255, 210, 0, 255) )
