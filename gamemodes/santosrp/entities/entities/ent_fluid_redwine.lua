...
function ENT:ConfigInit()
	if SERVER then
		self:SetModel( "models/foodnhouseholditems/wine_red1.mdl" )
		...
		self:SetFluidID( "Red Wine" )
		self:SetEffect( "waterFx", Vector(-0.088151, -0.650788, 8.061775), Color(200, 60, 40, 255) )
