...
function GM.Jobs:LoadJobs()
	...
	local foundFiles, foundFolders = file.Find( GM.Config.GAMEMODE_PATH.. "jobs/cl_*.lua", "LUA" )
...
hook.Add( "GamemodeDefineGameVars", "DefineJobVars", function()
	GAMEMODE.Player:DefineGameVar( "playtime", 0, "UInt32" )
end )