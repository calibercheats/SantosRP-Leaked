...
local Item = {}
Item.Name = "Police Issued SG 552 30rnd Mag"
Item.Desc = "SG 552 extended magazine attachment."
Item.Model = "models/Items/BoxMRounds.mdl"
Item.Weight = 2
Item.Volume = 1
Item.CanDrop = false
...
local Item = {}
Item.Name = "The Chief's Raging Bull"
...
Item.LimitID = "The Chief's Raging Bull"
GM.Inv:RegisterItem( Item )
GM.Inv:RegisterItemLimit( Item.LimitID, 1 )
...
Item.LimitID = "Police Issue SG 552"
GM.Inv:RegisterItem( Item )
GM.Inv:RegisterItemLimit( Item.LimitID, 1 )

local Item = {}
Item.Name = "Police Issue G36C"
...
Item.LimitID = "Police Issue G36C"
GM.Inv:RegisterItem( Item )
GM.Inv:RegisterItemLimit( Item.LimitID, 1 )
...
local Item = {}
Item.Name = "Police Issue .454 Casull 10 Rounds"
...
Item.PlayerCanUse = function( _, pPlayer )
	if pPlayer:GetAmmoCount( ".454 Casull" ) > 30 then
		pPlayer:AddNote( "You can't equip that much ammo!" )
		return false
	end
...
Item.OnUse = function( _, pPlayer )
	pPlayer:GiveAmmo( 30, ".454 Casull" )
end
