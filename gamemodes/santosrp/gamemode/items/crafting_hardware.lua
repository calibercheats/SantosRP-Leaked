...
Item.EquipGiveClass = "weapon_item_pipe"
GM.Inv:RegisterItem( Item )
...
Item.CanEquip = true
Item.EquipSlot = "PrimaryWeapon"
Item.EquipGiveClass = "weapon_item_wrench"
GM.Inv:RegisterItem( Item )
...
Item.CanEquip = true
Item.EquipSlot = "PrimaryWeapon"
Item.EquipGiveClass = "weapon_item_saw"
GM.Inv:RegisterItem( Item )
...
Item.CanEquip = true
Item.EquipSlot = "PrimaryWeapon"
Item.EquipGiveClass = "weapon_item_crowbar"
GM.Inv:RegisterItem( Item )
