...
GM.Net:RegisterEventHandle( "inv", "f", function( intMsgLen, pPlayer )
	...
	if numItems == 0 then
		...
		for i = 1, numItems do
			tbl[net.ReadString()] = net.ReadUInt( 32 )
		end
...
GM.Net:RegisterEventHandle( "inv", "s", function( intMsgLen, pPlayer )
	local itemName, itemAmount = net.ReadString(), net.ReadUInt( 32 )
