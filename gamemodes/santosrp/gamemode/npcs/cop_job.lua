...
NPCMeta.Model = "models/humans/santosrp/male_09_santosrp.mdl"
NPCMeta.Sounds = {
	StartDialog = {
...
function NPCMeta:PlayerJoinPolice( pPlayer )
	...
	if GAMEMODE.Jobs:CalcJobPlayerCap( JOB_POLICE ) <= GAMEMODE.Jobs:GetNumPlayers( JOB_POLICE ) and not hasFastPass then
