...
NPCMeta.Model = "models/humans/santosrp/male_05_santosrp.mdl"
NPCMeta.Sounds = {
	StartDialog = {
...
if SERVER then
	...
	function NPCMeta:PlayerRequestLawyer( pPlayer )
		...
		local numSent = GAMEMODE.Jobs:GetJobByID( JOB_LAWYER ):TextAllPlayers( "Jail", ("%s has requested the services of a lawyer at the police station."):format(pPlayer:Nick()) )
		if numSent > 0 then
