...
NPCMeta.Model = "models/humans/doctors/male_02_medic.mdl"
NPCMeta.Sounds = {
	StartDialog = {
...
function NPCMeta:BecomeJob( pPlayer, ... )
	...
	if GAMEMODE.Jobs:CalcJobPlayerCap( JOB_EMS ) <= GAMEMODE.Jobs:GetNumPlayers( JOB_EMS ) and not hasFastPass then
