...
function Panel:Init()
	...
	table.insert( self.m_tblSelect, self.m_pnlToolbar:AddButton("Call", "santosrp/phone/ic_menu_call.png", function()
	...
	table.insert( self.m_tblSelect, self.m_pnlToolbar:AddButton("Delete", "santosrp/phone/ic_menu_blocked_user.png", function()
...
function Panel:Init()
	...
	table.insert( self.m_tblSelect, self.m_pnlToolbar:AddButton("Add", "santosrp/phone/ic_menu_invite.png", function()
...
function Panel:BuildContacts()
	...
	local saved = util.JSONToTable( file.Read("santosrp/phone/contacts_".. char_id.. ".txt") or "" )
...
function Panel:SaveContacts()
	...
	file.Write( "santosrp/phone/contacts_".. char_id.. ".txt", util.TableToJSON(self.m_tblContacts) )
end
