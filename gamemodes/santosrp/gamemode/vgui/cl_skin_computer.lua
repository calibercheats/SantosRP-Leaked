...
SKIN.PrintName 		= "Computer Derma Skin"
SKIN.Author 		= "SantosRP"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material( "santosrp/computer/srpcomputer.png" )
...
derma.DefineSkin( "srp_comp", "SRPComputer", SKIN )