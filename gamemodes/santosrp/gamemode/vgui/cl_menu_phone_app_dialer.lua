...
function Panel:Init()
	...
	self.m_pnlBtnCallingAcceptCall:SetImage( "santosrp/phone/ic_jog_dial_answer.png" )
	...
	self.m_pnlBtnCallingDenyCall:SetImage( "santosrp/phone/ic_jog_dial_decline.png" )
	...
	self.m_pnlBtnCallEndCall:SetImage( "santosrp/phone/ic_jog_dial_decline.png" )
	...
	hook.Add( "GamemodePhoneBadNumber", "Phone", function()
		surface.PlaySound( "santosrp/phone_error.mp3" )
	end )

	hook.Add( "GamemodePhoneBusy", "Phone", function()
		surface.PlaySound( "santosrp/phone_busy.mp3" )
	end )
...
function Panel:Init()
	...
	table.insert( self.m_tblSelect, self.m_pnlToolbar:AddButton("Back", "santosrp/phone/ic_menu_revert.png", function()
		self:GetParent():GetParent():BackPage()
	end) )
	table.insert( self.m_tblSelect, self.m_pnlToolbar:AddButton("Contacts", "santosrp/phone/ic_menu_cc_am.png", function()
		self:GetParent():GetParent():ShowApp( "Contacts" )
	end) )

	self.m_tblBtnMats = {
		{ Key = "1", Mat = "santosrp/phone/sym_keyboard_num1.png" },
		{ Key = "2", Mat = "santosrp/phone/sym_keyboard_num2.png" },
		{ Key = "3", Mat = "santosrp/phone/sym_keyboard_num3.png" },
		{ Key = "4", Mat = "santosrp/phone/sym_keyboard_num4.png" },
		{ Key = "5", Mat = "santosrp/phone/sym_keyboard_num5.png" },
		{ Key = "6", Mat = "santosrp/phone/sym_keyboard_num6.png" },
		{ Key = "7", Mat = "santosrp/phone/sym_keyboard_num7.png" },
		{ Key = "8", Mat = "santosrp/phone/sym_keyboard_num8.png" },
		{ Key = "9", Mat = "santosrp/phone/sym_keyboard_num9.png" },
		{ Key = "back", Mat = "santosrp/phone/sym_keyboard_delete.png" },
		{ Key = "0", Mat = "santosrp/phone/sym_keyboard_num0_no_plus.png" },
		{ Key = "dial", Mat = "santosrp/phone/sym_action_call.png" },
	}
	...
	hook.Add( "GamemodePhoneCallOutgoing", "Phone", function( strNumber )
		...
		surface.PlaySound( "santosrp/phone_ring.mp3" )
...
function Panel:KeyPressed( strNum )
	if tonumber( strNum ) ~= nil then
		if self.m_strCurNumber:len() < 10 then
			...
			surface.PlaySound( "santosrp/dtmf".. strNum.. ".wav" )
		end
	else
		if strNum == "back" then
