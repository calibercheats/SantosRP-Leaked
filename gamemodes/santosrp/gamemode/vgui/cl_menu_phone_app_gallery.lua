...
function Panel:Init()
	...
	table.insert( self.m_tblSelect, self.m_pnlToolbar:AddButton("Set Contact", "santosrp/phone/ic_menu_cc_am.png", function()
		self.m_pnlPickContact:Rebuild()
		GAMEMODE.Gui.m_pnlPhone:ShowMenu( self.m_pnlPickContact )
	end) )
	table.insert( self.m_tblSelect, self.m_pnlToolbar:AddButton("Send To", "santosrp/phone/ic_menu_cc_am.png", function()
		self.m_pnlSendTo:Rebuild()
		GAMEMODE.Gui.m_pnlPhone:ShowMenu( self.m_pnlSendTo )
	end) )
	table.insert( self.m_tblSelect, self.m_pnlToolbar:AddButton("Delete", "santosrp/phone/ic_menu_close_clear_cancel.png", function()
...
function Panel:PurgeTempPhotos()
	...
	local files, _ = file.Find( "santosrp/phone/temp_photos/".. char_id.. "/*", "DATA" )
	for k, v in pairs( files ) do
		file.Delete( "santosrp/phone/temp_photos/".. char_id.. "/".. v )
	end
end
...
function Panel:BuildPhotos()
	...
	self.m_tblPhotos = {}
	local files, _ = file.Find( "santosrp/phone/photos/".. char_id.. "/*", "DATA" )
	for k, v in pairs( files ) do
		table.insert( self.m_tblPhotos, { Name = v, Path = "santosrp/phone/photos/".. char_id.. "/" } )
	end
end
