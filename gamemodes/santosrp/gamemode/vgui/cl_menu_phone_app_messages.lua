...
local MAT_NEWMSG = Material( "santosrp/phone/ic_menu_notifications.png" )
...
function Panel:Init()
	...
	table.insert( self.m_tblSelect, self.m_pnlToolbar:AddButton("Save", "santosrp/phone/ic_menu_save.png", function()
...
function Panel:Init()
	...
	table.insert( self.m_tblSelect, self.m_pnlToolbar:AddButton("Remove", "santosrp/phone/ic_menu_close_clear_cancel.png", function()
		self:GetParent():GetParent():BackPage()
...
function Panel:Init()
	...
	table.insert( self.m_tblSelect, self.m_pnlToolbar:AddButton("New Thread", "santosrp/phone/ic_menu_invite.png", function()
...
function Panel:WriteTempPhoto( strName, strImageData )
	...
	if not file.IsDir( "santosrp/phone", "DATA" ) then
		file.CreateDir( "santosrp/phone" )
	end
	if not file.IsDir( "santosrp/phone/temp_photos", "DATA" ) then
		file.CreateDir( "santosrp/phone/temp_photos" )
	end
	if not file.IsDir( "santosrp/phone/temp_photos/".. char_id, "DATA" ) then
		file.CreateDir( "santosrp/phone/temp_photos/".. char_id )
	end

	file.Write( "santosrp/phone/temp_photos/".. char_id.. "/".. strName.. ".txt", strImageData )
	return "santosrp/phone/temp_photos/".. char_id.. "/".. strName.. ".txt"
end
