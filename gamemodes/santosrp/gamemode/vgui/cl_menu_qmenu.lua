...
function Panel:Init()
	...
	self.m_pnlTabRules = self.m_pnlTabs:AddSheet( "Rules", vgui.Create("SRPQMenu_Rules", self) ).Panel
	--self.m_pnlTabWebsite = self.m_pnlTabs:AddSheet( "Website", vgui.Create("srp_QMenu_Website", self) ).Panel
end
