...
local Panel = {}
function Panel:Init()
	self.m_matIcon = Material( "santosrp/phone/phone.png" )
	self:SetText( " " )
end
...
local Panel = {}
function Panel:Init()
	self.m_matSignal = Material( "santosrp/phone/stat_sys_signal_evdo_1.png", "noclamp" )
...
function Panel:Init()
	...
	self.m_matBG = Material( "santosrp/phone/android_01.png", "noclamp" )
	self.m_matWallpaper = Material( "santosrp/phone/wallpapers/grass.png", "noclamp smooth" )
	self.m_intMenuX = 23
	self.m_intMenuY = 43
